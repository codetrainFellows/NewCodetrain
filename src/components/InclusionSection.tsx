    ...
    <section className="bg-white min-h-[90vh] flex flex-col justify-center py-12 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto w-full flex flex-col h-full gap-8 lg:gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {cards.map((card, idx) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className={`${card.bgColor} rounded-xl overflow-hidden shadow-sm border border-slate-100 flex flex-col hover:shadow-md transition-shadow`}
            >
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center bg-[#fdfdfd] p-4 lg:p-6 rounded-3xl border border-slate-50"
        >
          {/* Left: Image */}
